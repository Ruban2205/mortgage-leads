    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-br from-muted/40 via-muted/20 to-blue-50 py-14 sm:py-20 section-dots">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-teal-100 border border-teal-200 px-4 py-1.5 mb-5">
            <span className="text-xs font-semibold text-teal-700 uppercase tracking-wider">💰 Down Payment Guide</span>
          </div>
