    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-br from-rose-50 via-slate-50 to-orange-50 py-14 sm:py-20 section-dots">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-rose-100 border border-rose-200 px-3 py-1 mb-4">
            <span className="text-xs font-semibold text-rose-700 uppercase tracking-wide">📊 Credit & Debt Guide</span>
          </div>
