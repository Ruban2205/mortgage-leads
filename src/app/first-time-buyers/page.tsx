    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-br from-violet-50 via-slate-50 to-blue-50 py-14 sm:py-20 section-dots">
        <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-violet-100 border border-violet-200 px-4 py-1.5 mb-5">
            <span className="text-xs font-semibold text-violet-700 uppercase tracking-wider">🏠 First-Time Buyer Guide</span>
          </div>
