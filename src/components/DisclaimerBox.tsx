...
export default function DisclaimerBox({
  ...
  if (variant === "page") {
    return (
      <div className={`rounded-2xl border border-amber-200 dark:border-amber-500/20 bg-amber-50 dark:bg-amber-500/10 p-6 ${className}`}>
        <div className="flex items-start gap-4">
          ...
          <div>
            <p className="text-sm font-bold text-amber-900 dark:text-amber-300 mb-2 uppercase tracking-wide">
              Important Disclaimer
            </p>
            <div className="space-y-2 text-sm text-amber-800 dark:text-amber-400 leading-relaxed">
              <p>
  ...
  return (
    <div className={`rounded-xl border border-amber-200 dark:border-amber-500/20 bg-amber-50 dark:bg-amber-500/10 p-4 ${className}`}>
